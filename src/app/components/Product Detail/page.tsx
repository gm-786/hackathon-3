  ...
  return (
    <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between p-6 rounded-lg bg-white w-[90%] max-w-[1200px] mx-auto mt-4 py-8 lg:gap-20">
      ...
      <div className="lg:w-1/2 mt-6 lg:mt-0 text-center lg:text-left">
        {/* Title */}
        <h2
          className={`text-xl lg:text-4xl font-medium text-black mb-4 ${poppins.className}`}
        >
        ...
        {/* Description */}
        <p
          className={`text-sm font-light text-black mb-6 leading-7 ${poppins.className}`}
        >
          Turn style on its head with this crafted take on the Air Jordan 1
          Mid. Its inside out-inspired construction, including unique
          layering and exposed foam accents, ups the ante on this timeless
          Jordan Brand silhouette. Details like the deco stitching on the
          Swoosh add coveted appeal, while the unexpected shading, rich mixture
          of materials and aged midsole aesthetic give this release an artisan
          finish.
        </p>

        {/* Price */}
        <p
          className={`text-4xl font-medium text-black mb-6 ${poppins.className}`}
        >
          ₹ 8,695.00
        </p>
